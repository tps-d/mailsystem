    ...
    <ul class="nav flex-column mt-4">
        ...
        <li class="nav-item">
            <a class="nav-link" href="javascript:;" role="button"  >
                <i class="fa-fw fas fa-paper-plane mr-2"></i><span>{{ __('lang.Campaigns') }}</span>
            </a>
            <ul>
        ...
        <li class="nav-item">
            <a class="nav-link" href="javascript:;">
                <i class="fa-fw fas fa-envelope mr-2"></i><span>{{ __('lang.Messages') }}</span>
            </a>
            <ul>
        ...
        <li class="nav-item">
            ...
            <ul>
              @auth()
              <li class="nav-item {{ request()->is('users*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('users.index') }}">{{ __('lang.Manage_Users') }}</a></li>
               @endauth
