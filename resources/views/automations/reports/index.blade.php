...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col-md-3 col-sm-6 mb-md-0 mb-3">
            <a href="{{ route('campaigns.reports.recipients', $campaign->id) }}"
        ...
        <div class="col-md-3 col-sm-6 mb-md-0 mb-3">
            <a href="{{ route('campaigns.reports.opens', $campaign->id) }}"
               class="text-decoration-none text-reset">
                <div class="widget flex-row align-items-center align-items-stretch">
                    <div class="col-8 py-4 rounded-right">
        ...
        <div class="col-md-3 col-sm-6 mb-md-0 mb-3">
            <a href="{{ route('campaigns.reports.clicks', $campaign->id) }}"
               class="text-decoration-none text-reset">
                <div class="widget flex-row align-items-center align-items-stretch">
                    <div class="col-8 py-4 rounded-right">
        ...
        <div class="col-md-3 col-sm-6 mb-md-0 mb-3">
            <a href="{{ route('campaigns.reports.bounces', $campaign->id) }}"
               class="text-decoration-none text-reset">
